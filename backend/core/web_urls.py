...
urlpatterns = [
    ...
    path("master-entry/district/<int:district_id>/summary/", web_views.DistrictMasterEntryInlineSummaryView.as_view(), name="master-entry-district-summary"),
    ...
    path("master-entry/public/<int:pk>/summary/", web_views.PublicMasterEntryInlineSummaryView.as_view(), name="master-entry-public-summary"),
    ...
    path("master-entry/institutions/<str:application_number>/summary/", web_views.InstitutionsMasterEntryInlineSummaryView.as_view(), name="master-entry-institution-summary"),
    ...
    path("seat-allocation/", web_views.SeatAllocationListView.as_view(), name="seat-allocation-list"),
    ...
    path("purchase-orders/<int:pk>/edit/", web_views.PurchaseOrderUpdateView.as_view(), name="purchase-order-edit"),
    path("purchase-orders/<int:pk>/pdf/", web_views.PurchaseOrderPDFView.as_view(), name="purchase-order-pdf"),
    path("purchase-orders/<int:pk>/submit/", web_views.PurchaseOrderSubmitView.as_view(), name="purchase-order-submit"),
